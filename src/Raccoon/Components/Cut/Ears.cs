    ...
    public static class Ears {
        ...
        public static Polyline[] Notches(Polyline x0, Polyline x1, double R, byte[] T) {
            ...
            for (int i = closed; i < xA.Count - closed; i++) {
                ...
                ///////////////////////////////////////////////////////////////////////
                Plane pl0 = NGonsCore.PlaneUtil.AlignPlane(normalPl, v0);
                Plane pl1 = NGonsCore.PlaneUtil.AlignPlane(normalPl, v1);

                //for sharp angles extension is needed
                double extension0 = angle < (Math.PI * 0.5) ? NGonsCore.VectorUtil.VectorProjection(v0 * r, v1 * r).Length : 0;
                double extension1 = angle < (Math.PI * 0.5) ? NGonsCore.VectorUtil.VectorProjection(v1 * r, v0 * r).Length : 0;
                extension0 *= 0;
                extension1 *= 0;
                ...
                Plane pl2normalXAxis2Fillet = NGonsCore.PlaneUtil.AlignPlane(normalPl, bisectorDir);
                ...
                Plane pl2 = NGonsCore.PlaneUtil.AlignPlane(normalPl, bisectorDirFillet);
