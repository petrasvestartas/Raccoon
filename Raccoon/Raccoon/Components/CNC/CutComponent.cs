...
namespace Raccoon.Components.CNC
{
    public class CutModel : CustomComponent
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Raccoon_Library.CutType cutType = Raccoon_Library.CutType.OpenCut;
            double cutType_ = 0;
            DA.GetData(2, ref cutType_);
            cutType = (Raccoon_Library.CutType)cutType_;
            ...
            Raccoon_Library.Cut cut = new Raccoon_Library.Cut(id, cutPolyline, normal, cutType, project, notchesTypes, filletR, CutOrHole, PolylineMergeTakeOutside, merge, projectRotate, SawFlip90Cut);
            DA.SetData(0, cut);
        }
