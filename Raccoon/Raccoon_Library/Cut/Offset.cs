...
namespace Raccoon_Library
{
    public static class Offset
    {
        ...
        public static Polyline OffsetRectangle(Polyline ClosedPolyline, double dist)
        {
            ...
            //Ignore this option because it causes random diagonals along the pipeline...
            //User must set correct orientation himself...
            //Take two segments that are more equal length than the other pair, by compairing their lengths
            double proportion0 = ClosedPolyline.SegmentAt(0).Length < ClosedPolyline.SegmentAt(2).Length ?
                ClosedPolyline.SegmentAt(0).Length / ClosedPolyline.SegmentAt(2).Length :
                ClosedPolyline.SegmentAt(2).Length / ClosedPolyline.SegmentAt(0).Length;
            double proportion1 = ClosedPolyline.SegmentAt(1).Length < ClosedPolyline.SegmentAt(3).Length ?
                ClosedPolyline.SegmentAt(1).Length / ClosedPolyline.SegmentAt(3).Length :
                ClosedPolyline.SegmentAt(3).Length / ClosedPolyline.SegmentAt(1).Length;

            Raccoon_Library.GlobalParameters.sort_rectangular_tool_path_by_edge_length = false;
            bool sort = Raccoon_Library.GlobalParameters.sort_rectangular_tool_path_by_edge_length ? proportion0 < proportion1 : false;
            //sort = proportion0<proportion1;
            ...
            pline.Add(ClosedPolyline[2]);
            pline.Add(ClosedPolyline[3]);
            pline.Add(ClosedPolyline[0]);
            pline.Add(ClosedPolyline[1]);
            pline.Add(ClosedPolyline[2]);
