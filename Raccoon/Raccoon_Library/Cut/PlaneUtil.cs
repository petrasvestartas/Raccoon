...
namespace Raccoon_Library
{
    public static class PlaneUtil
    {
        ...
        public static Polyline ToPolyline(this List<Plane> planes, double moveByNormal = 0)
        {
            Polyline pline = new Polyline();
            foreach (var pl in planes)
                pline.Add(pl.Origin + pl.Normal * moveByNormal);
            return pline;
        }
        ...
        /// <returns></returns>
        public static Plane PlaneFromLinePlane(this Line l0, Plane plane, int perpendicularToEdge = 0)
        {//2
